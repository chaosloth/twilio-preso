...
export const STAGES: StageDefinition[] = [
  ...
  { index: 17, id: 'mcp-server', title: 'Twilio MCP Server', act: 3, notes: "How did we build all of this so fast? The Twilio MCP server wires your AI coding agent straight into Twilio's full API surface — 1,800+ endpoints across 30+ products. No more tab-switching between docs and your IDE. Search-then-retrieve keeps context lean. No auth, no install — just point your agent at mcp.twilio.com/docs. Public Beta.", interaction: null },
  { index: 18, id: 'ai-playground', title: 'Ask the Agent', act: 3, notes: "Hand the mic to the audience. Everyone's phone now has a prompt box wired to a live Claude-powered agent. Have them ask it anything — their questions and the AI's replies stream onto this screen in real time. This is the MCP-built agent, live.", interaction: { stageIndex: 18, type: 'llm-prompt', prompt: 'Ask our live AI agent anything about Twilio 👇', example: 'How would I send a WhatsApp message with Twilio?' } },

  // ACT 4
  { index: 19, id: 'innovation', title: 'Where Do You Need This to Run?', act: 4, notes: 'Launch poll with freeform option. Where does the audience need this to run?', interaction: { stageIndex: 19, type: 'poll', prompt: 'Where do you need this to run?', options: ['AWS', 'Google', 'Microsoft', 'On Premise'], allowFreeform: true } },
  { index: 20, id: 'never-easier', title: "It's Never Been Easier", act: 4, notes: 'Show aggregate stats. How many people participated, how many messages sent. The presentation itself was the demo.', interaction: null },
  { index: 21, id: 'mass-call', title: 'Mass Outbound Call', act: 4, notes: "The big finale demo. Every phone in the room rings simultaneously — connected to the AI bot we just 'built' on stage. Maximum wow factor.", interaction: null, demoTrigger: 'voice-mass-outbound' },
  { index: 22, id: 'closing', title: 'letsGoMichelangeloMode();', act: 4, notes: 'Thank the audience. SMS with link goes out.', interaction: null, demoTrigger: 'sms-closing' },
];

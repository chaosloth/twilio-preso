...
export default function Stage17NeverEasier() {
  ...
  return (
    <group>
      ...
      {/* Stats */}
      <FloatingText position={[-3, 0.5, 0]} fontSize={0.8} color="#ef223a" bold delay={0.5}>
        {String(participants)}
      </FloatingText>
      ...
      <FloatingText position={[0, 0.5, 0]} fontSize={0.8} color="#ef223a" bold delay={0.7}>
      ...
      <FloatingText position={[3, 0.5, 0]} fontSize={0.8} color="#ef223a" bold delay={0.9}>
        19
      </FloatingText>
